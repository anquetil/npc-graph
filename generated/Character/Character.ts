...
export class Character extends ethereum.SmartContract {
  ...
  svgStorageBase(): Address {
    let result = super.call("svgStorageBase", "svgStorageBase():(address)", []);

    return result[0].toAddress();
  }

  try_svgStorageBase(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "svgStorageBase",
      "svgStorageBase():(address)",
      []
  ...
  try_svgStorageEmpty(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "svgStorageEmpty",
      "svgStorageEmpty():(address)",
      []
...
export class ConstructorCall__Inputs {
  ...
  get _svgStorageBase(): Address {
    return this._call.inputValues[3].value.toAddress();
  }

  get _svgStorageEmpty(): Address {
